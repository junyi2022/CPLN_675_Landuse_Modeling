...
path <- "C:/JunyiYang/UPenn/Spring_2025/landuse_modeling/CPLN_675_Landuse_Modeling/Week_13/data/"
...
developed <- points$finished$geometry %>% st_sf() %>% mutate(class = "developed", id = 1)
```
